...
describe("Matrix test suite", () => {
	...
	it("convolute identity", () => {
		...
		expect(res.elements[0][0].toNumber()).to.equal(2);
		expect(res.elements[0][1].toNumber()).to.equal(3);
		expect(res.elements[0][2].toNumber()).to.equal(-2);
		expect(res.elements[0][3].toNumber()).to.equal(4);
		expect(res.elements[1][0].toNumber()).to.equal(-3);
		expect(res.elements[1][1].toNumber()).to.equal(2);
		expect(res.elements[1][2].toNumber()).to.equal(2);
		expect(res.elements[1][3].toNumber()).to.equal(1);
		expect(res.elements[2][0].toNumber()).to.equal(0);
		expect(res.elements[2][1].toNumber()).to.equal(4);
		expect(res.elements[2][2].toNumber()).to.equal(1);
		expect(res.elements[2][3].toNumber()).to.equal(1);
		expect(res.elements[3][0].toNumber()).to.equal(2);
		expect(res.elements[3][1].toNumber()).to.equal(3);
		expect(res.elements[3][2].toNumber()).to.equal(0);
		expect(res.elements[3][3].toNumber()).to.equal(2);
	});
	it("convolute", () => {
		const m: Matrix = new Matrix(4, 4);
		m.elements = [[new RationalNumber(2), new RationalNumber(3), new RationalNumber(-2), new RationalNumber(4)],
			...
			[new RationalNumber(2), new RationalNumber(3), new RationalNumber(0), new RationalNumber(2)]];
		const kernel: Matrix = new Matrix(3, 3);
		kernel.elements = [[new RationalNumber(0), new RationalNumber(-1), new RationalNumber(0)],
				[new RationalNumber(-1), new RationalNumber(4), new RationalNumber(-1)],
				[new RationalNumber(0), new RationalNumber(-1), new RationalNumber(0)]];
		const res = m.convolute(kernel);
		const a = m.elements;
		const k = kernel.elements;
		expect(res.elements[0][0].toNumber()).to.equal(	 a[0][0].mult(k[1][1]).
														add(a[0][1].mult(k[1][2])).
														add(a[1][0].mult(k[2][1])).
														add(a[1][1].mult(k[2][2])).toNumber());
		expect(res.elements[0][1].toNumber()).to.equal(	 a[0][0].mult(k[1][0]).
														add(a[0][1].mult(k[1][1])).
														add(a[0][2].mult(k[1][2])).
														add(a[1][0].mult(k[2][0])).
														add(a[1][1].mult(k[2][1])).
														add(a[1][2].mult(k[2][2])).toNumber());
		expect(res.elements[0][2].toNumber()).to.equal(	 a[0][1].mult(k[1][0]).
														add(a[0][2].mult(k[1][1])).
														add(a[0][3].mult(k[1][2])).
														add(a[1][0].mult(k[2][0])).
														add(a[1][1].mult(k[2][1])).
														add(a[1][3].mult(k[2][2])).toNumber());
		expect(res.elements[0][3].toNumber()).to.equal(	 a[0][2].mult(k[1][0]).
														add(a[0][3].mult(k[1][1])).
														add(a[1][2].mult(k[2][0])).
														add(a[1][3].mult(k[2][1])).toNumber());
		expect(res.elements[1][0].toNumber()).to.equal(	 a[0][0].mult(k[0][1]).
														add(a[0][1].mult(k[0][2])).
														add(a[1][0].mult(k[1][1])).
														add(a[1][1].mult(k[1][2])).
														add(a[2][0].mult(k[2][1])).
														add(a[2][1].mult(k[2][2])).toNumber());
		expect(res.elements[1][1].toNumber()).to.equal(	 a[0][0].mult(k[0][0]).
														add(a[0][1].mult(k[0][1])).
														add(a[0][2].mult(k[0][2])).
														add(a[1][0].mult(k[1][0])).
														add(a[1][1].mult(k[1][1])).
														add(a[1][2].mult(k[1][2])).
														add(a[2][0].mult(k[2][0])).
														add(a[2][1].mult(k[2][1])).
														add(a[2][2].mult(k[2][2])).toNumber());
		expect(res.elements[1][2].toNumber()).to.equal(	 a[0][1].mult(k[0][0]).
														add(a[0][2].mult(k[0][1])).
														add(a[0][3].mult(k[0][2])).
														add(a[1][1].mult(k[1][0])).
														add(a[1][2].mult(k[1][1])).
														add(a[1][3].mult(k[1][2])).
														add(a[2][1].mult(k[2][0])).
														add(a[2][2].mult(k[2][1])).
														add(a[2][3].mult(k[2][2])).toNumber());
		expect(res.elements[1][3].toNumber()).to.equal(	 a[0][2].mult(k[0][0]).
														add(a[0][3].mult(k[0][1])).
														add(a[1][2].mult(k[1][0])).
														add(a[1][3].mult(k[1][1])).
														add(a[2][2].mult(k[2][0])).
														add(a[2][3].mult(k[2][1])).toNumber());
	});
});