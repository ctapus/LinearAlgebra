...
var Game = /*#__PURE__*/function () {
  ...
  function Game(rows, columns) {
    var density = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  ...
  _createClass(Game, [{
    key: "addCell",
    value: function addCell(row, column) {
      this.cells[row][column] = 1;
    }
  }, {
    key: "printGame",
    value: function printGame(printFunction) {
    ...
    value: function heartbeat() {
      ...
      for (var r = 0; r < this.cells.length; r++) {
        ...
        for (var c = 0; c < this.cells[r].length; c++) {
          var neighbours = this.getCellNeighbours(r, c);
          var aliveNeighbours = neighbours.reduce(function (acc, cur) {
            return acc + cur;
          });
          newCells[r][c] = 0;
    ...
    key: "getCellNeighbours",
    value: function getCellNeighbours(row, column) {
      var ret = [];
      var rows = [row];
      var columns = [column];
...
$(document).ready(function () {
  ...
  var cellAliveFillStyle = "#000000";
  var cellDeadFillStyle = "#ffffff";
  var unitSize = 10;
  $("#legend").append($("<div></div>").text("Canvas size: " + canvasWidth + " x " + canvasHeight + " px"));
  drawOrthonormalGrid();
  var game = new Game(canvasHeight / unitSize, canvasWidth / unitSize, 0.3);
  ...
  function drawOrthonormalGrid() {
    ...
    for (var x = 0; x < canvasWidth; x += unitSize) {
      ctx.moveTo(x, 0);
      ctx.lineTo(x, canvasHeight);
      ctx.stroke();
    }

    for (var y = 0; y < canvasHeight; y += unitSize) {
      ctx.moveTo(0, y);
