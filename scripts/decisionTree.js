...
/*!****************************************!*\
  !*** ./src/structures/DecisionTree.ts ***!
  \****************************************/
/*! exports provided: Question, DecisionTree */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class DecisionTree {
    ...
    static partitionData(data, question) {
        let left = new Array();
        let right = new Array();
        for (const x of data) {
            if (question.match(x)) {
    ...
    static calculateBestSplit(dataset, labelsColumnIndex) {
        ...
        for (let colIdx = 0; colIdx < dataset.length; colIdx++) {
            ...
            for (const currentValue of values) {
                ...
                const trueColumn = this.getColumnFromArray(partition[0], colIdx);
                const falseColumn = this.getColumnFromArray(partition[1], colIdx);
                const informationGain = this.calculateInformationGain(trueColumn, falseColumn, currentUncertainty);
