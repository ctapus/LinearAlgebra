...
class DecisionTree {
    ...
    static partitionData(dataset, question) {
        let trueBranch = new Array();
        let falseBranch = new Array();
    ...
    static calculateBestSplit(dataset, labelsColumnIndex) {
        ...
        let currentUncertainty = this.calculateGiniImpurity(dataset, labelsColumnIndex);
        for (let colIdx = 0; colIdx < dataset.length; colIdx++) {
            ...
            for (const currentValue of values) {
                ...
                let [trueBranch, falseBranch] = this.partitionData(dataset, question);
