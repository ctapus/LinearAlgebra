...
$(document).ready(() => {
    ...
    for (let i = 0; i < dataset[0].length; i++) {
        const giniIndex = DecisionTree.calculateGini(DecisionTree.getColumnFromArray(dataset, i));
