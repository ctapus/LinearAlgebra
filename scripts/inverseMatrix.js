...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/exercises/inverseMatrix.ts");
/******/ })
/************************************************************************/
/******/ ({
...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(() => {
    let undoStack;
    let redoStack;
    const initialMatrix = _structures_Matrix__WEBPACK_IMPORTED_MODULE_2__["Matrix"].randomSquare();
    let workingMatrix = null;
    let operationDivIdx = 0;
    init();
    _presenters_MatrixPresenter__WEBPACK_IMPORTED_MODULE_1__["MatrixPresenter"].printTableMatrix(initialMatrix, jquery__WEBPACK_IMPORTED_MODULE_0__("#content"));
    jquery__WEBPACK_IMPORTED_MODULE_0__("#btnAugmentMatrix").click(() => {
        jquery__WEBPACK_IMPORTED_MODULE_0__("#error").text("");
        preProcessOperation();
        if ("A" === jquery__WEBPACK_IMPORTED_MODULE_0__("#selAugmentOptions1").val()) {
            workingMatrix = initialMatrix.deepCopy();
        }
        if ("I" === jquery__WEBPACK_IMPORTED_MODULE_0__("#selAugmentOptions1").val()) {
            workingMatrix = new _structures_Matrix__WEBPACK_IMPORTED_MODULE_2__["MatrixIdentity"](initialMatrix.m);
        }
        if ("A" === jquery__WEBPACK_IMPORTED_MODULE_0__("#selAugmentOptions2").val()) {
            workingMatrix = _structures_Matrix__WEBPACK_IMPORTED_MODULE_2__["Matrix"].augment(workingMatrix, initialMatrix);
        }
        if ("I" === jquery__WEBPACK_IMPORTED_MODULE_0__("#selAugmentOptions2").val()) {
            workingMatrix = _structures_Matrix__WEBPACK_IMPORTED_MODULE_2__["Matrix"].augment(workingMatrix, new _structures_Matrix__WEBPACK_IMPORTED_MODULE_2__["MatrixIdentity"](initialMatrix.m));
        }
        postProcessOperation("Augmented " + jquery__WEBPACK_IMPORTED_MODULE_0__("#selAugmentOptions1").val() + " with " + jquery__WEBPACK_IMPORTED_MODULE_0__("#selAugmentOptions2").val() + ".");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__("#btnSwitchRows").click(() => {
        jquery__WEBPACK_IMPORTED_MODULE_0__("#error").text("");
        const idxRow1 = Number(jquery__WEBPACK_IMPORTED_MODULE_0__("#row1").val()) - 1;
        const idxRow2 = Number(jquery__WEBPACK_IMPORTED_MODULE_0__("#row2").val()) - 1;
        if (0 > idxRow1 || workingMatrix.m < idxRow1 || 0 > idxRow2 || workingMatrix.m < idxRow2) {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#error").text("Row index must be greater than 0 and smaller than " + workingMatrix.m);
            return;
        }
        preProcessOperation();
        workingMatrix.switchRows(idxRow1, idxRow2);
        postProcessOperation("Switched row " + jquery__WEBPACK_IMPORTED_MODULE_0__("#row1").val() + " with row " + jquery__WEBPACK_IMPORTED_MODULE_0__("#row2").val() + ".");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__("#btnMultiplyRow").click(() => {
        jquery__WEBPACK_IMPORTED_MODULE_0__("#error").text("");
        const idxRow = Number(jquery__WEBPACK_IMPORTED_MODULE_0__("#rowIdx").val()) - 1;
        const scalar = _structures_RationalNumber__WEBPACK_IMPORTED_MODULE_3__["RationalNumber"].fromString(jquery__WEBPACK_IMPORTED_MODULE_0__("#scalar").val().toString());
        ...
        postProcessOperation("Multiplied row " + jquery__WEBPACK_IMPORTED_MODULE_0__("#rowIdx").val() + " with scalar" + jquery__WEBPACK_IMPORTED_MODULE_0__("#scalar").val() + ".");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__("#btnAddRows").click(() => {
        jquery__WEBPACK_IMPORTED_MODULE_0__("#error").text("");
        const idxRow1 = Number(jquery__WEBPACK_IMPORTED_MODULE_0__("#addRow1Idx").val()) - 1;
        const idxRow2 = Number(jquery__WEBPACK_IMPORTED_MODULE_0__("#addRow2Idx").val()) - 1;
        const scalar1 = _structures_RationalNumber__WEBPACK_IMPORTED_MODULE_3__["RationalNumber"].fromString(jquery__WEBPACK_IMPORTED_MODULE_0__("#addRow1Mult").val().toString());
        const scalar2 = _structures_RationalNumber__WEBPACK_IMPORTED_MODULE_3__["RationalNumber"].fromString(jquery__WEBPACK_IMPORTED_MODULE_0__("#addRow2Mult").val().toString());
        if (0 > idxRow1 || workingMatrix.m < idxRow1 || 0 > idxRow2 || workingMatrix.m < idxRow2) {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#error").text("Row index must be greater than 0 and smaller than " + workingMatrix.m);
            return;
        }
        ...
        postProcessOperation(`Added ${scalar1} time(s) row ${jquery__WEBPACK_IMPORTED_MODULE_0__("#addRow1Idx").val()} to ${scalar2} time(s) row ${jquery__WEBPACK_IMPORTED_MODULE_0__("#addRow2Idx").val()}.`);
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__("#btnUndo").click(() => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__("#" + divId).hide();
        const buttonId = "toggleButton" + operationDivIdx;
        jquery__WEBPACK_IMPORTED_MODULE_0__("#" + buttonId).hide();
        --operationDivIdx;
        divId = "operationDiv" + operationDivIdx;
        jquery__WEBPACK_IMPORTED_MODULE_0__("#" + divId).show();
        setEditOperations();
        setAvailableOperations();
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__("#btnRedo").click(() => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__("#" + divId).show();
        const buttonId = "toggleButton" + operationDivIdx;
        jquery__WEBPACK_IMPORTED_MODULE_0__("#" + buttonId).show();
        setEditOperations();
        setAvailableOperations();
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__("#btnReset").click(() => {
        init();
        while (operationDivIdx > 0) {
            const divId = "operationDiv" + operationDivIdx;
            jquery__WEBPACK_IMPORTED_MODULE_0__("#" + divId).remove();
            const buttonId = "toggleButton" + operationDivIdx;
            jquery__WEBPACK_IMPORTED_MODULE_0__("#" + buttonId).remove();
            --operationDivIdx;
        }
        setEditOperations();
        setAvailableOperations();
    ...
    function postProcessOperation(title) {
        ...
        if (operationDivIdx > 0) {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#" + "operationDiv" + operationDivIdx).toggle();
        }
        ++operationDivIdx;
        const divId = "operationDiv" + operationDivIdx;
        const div = jquery__WEBPACK_IMPORTED_MODULE_0__("<div id='" + divId + "'></div>");
        const buttonId = "toggleButton" + operationDivIdx;
        const toggleButton = jquery__WEBPACK_IMPORTED_MODULE_0__("<button id='" + buttonId + "'></button>").addClass("operationButton").text(title);
        jquery__WEBPACK_IMPORTED_MODULE_0__(document).on("click", "#" + buttonId, () => {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#" + divId).toggle();
        });
        jquery__WEBPACK_IMPORTED_MODULE_0__("#content").append(toggleButton);
        jquery__WEBPACK_IMPORTED_MODULE_0__("#content").append(div);
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__("#selAugmentOptions1").val("");
        jquery__WEBPACK_IMPORTED_MODULE_0__("#selAugmentOptions2").val("");
        jquery__WEBPACK_IMPORTED_MODULE_0__("#row1").val("");
        jquery__WEBPACK_IMPORTED_MODULE_0__("#row2").val("");
        jquery__WEBPACK_IMPORTED_MODULE_0__("#rowIdx").val("");
        jquery__WEBPACK_IMPORTED_MODULE_0__("#scalar").val("1");
        jquery__WEBPACK_IMPORTED_MODULE_0__("#addRow1Idx").val("");
        jquery__WEBPACK_IMPORTED_MODULE_0__("#addRow1Mult").val("1");
        jquery__WEBPACK_IMPORTED_MODULE_0__("#addRow2Idx").val("");
        jquery__WEBPACK_IMPORTED_MODULE_0__("#addRow2Mult").val("1");
        setEditOperations();
        setAvailableOperations();
    }
    function setEditOperations() {
        if (undoStack.isEmpty()) {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#btnUndo").prop("disabled", true);
        }
        else {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#btnUndo").prop("disabled", false);
        }
        if (redoStack.isEmpty()) {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#btnRedo").prop("disabled", true);
        }
        else {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#btnRedo").prop("disabled", false);
        }
    }
    function clearRedo() {
    ...
    function setAvailableOperations() {
        if (null == workingMatrix) {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#divAugmentMatrix").show();
            jquery__WEBPACK_IMPORTED_MODULE_0__("#divSwitchRows").hide();
            jquery__WEBPACK_IMPORTED_MODULE_0__("#divMultiplyRow").hide();
            jquery__WEBPACK_IMPORTED_MODULE_0__("#divAddRows").hide();
        }
        else {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#divAugmentMatrix").hide();
            jquery__WEBPACK_IMPORTED_MODULE_0__("#divSwitchRows").show();
            jquery__WEBPACK_IMPORTED_MODULE_0__("#divMultiplyRow").show();
            jquery__WEBPACK_IMPORTED_MODULE_0__("#divAddRows").show();
        }
    }
});
...
/* harmony import */ var _structures_Queue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../structures/Queue */ "./src/structures/Queue.ts");
...
/* harmony import */ var _structures_Stack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../structures/Stack */ "./src/structures/Stack.ts");
...
/* harmony import */ var _structures_ArithmeticEvaluator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../structures/ArithmeticEvaluator */ "./src/structures/ArithmeticEvaluator.ts");
/* harmony import */ var _structures_Queue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../structures/Queue */ "./src/structures/Queue.ts");
/* harmony import */ var _structures_Stack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../structures/Stack */ "./src/structures/Stack.ts");
...
class Vector {
    ...
    length() {
        const length = new _structures_RationalNumber__WEBPACK_IMPORTED_MODULE_1__["RationalNumber"](0);
        for (let i = 0; i < this.m; i++) {
