...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/exercises/fractals.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function($) {// The Mandelbrot set consists of all of those (complex) c-values for which the corresponding orbit of 0 under x^2 + c does not escape to infinity.
...
$(document).ready(function () {
  ...
  var offsetX = parseInt($("#xOffset").val(), 10);
  var offsetY = parseInt($("#yOffset").val(), 10);
  var zoom = parseInt($("#zoom").val(), 10);
  var originX = canvasWidth / 2;
  var originY = canvasHeight / 2;
  var maxSquaredAbsoluteValue = 2 * 2;
  ...
  function viewportToComplex(x, y) {
    // Don't use the ComplexNumber for performance reasons
  ...
  function diverges(cx, cy) {
    var a = 0;
    var b = 0;
    var squaredAbsoluteValue = 0;
    var iteration = maxIterations;

    do {
      // x1 = x0^2 + c
      var temp = Math.pow(a, 2) - Math.pow(b, 2) + cx;
      b = 2 * a * b + cy;
      a = temp;
  ...
  function drawFractal() {
    var redPixel = ctx.createImageData(1, 1);
    redPixel.data[0] = 255;
    redPixel.data[1] = 0;
    redPixel.data[2] = 0;
    redPixel.data[3] = 255;
    var bluePixel = ctx.createImageData(1, 1);
    bluePixel.data[0] = 0;
    bluePixel.data[1] = 0;
  ...
  $("#xOffset").change(function () {
    offsetX = parseFloat($("#xOffset").val());
    drawFractal();
  });
  $("#yOffset").change(function () {
    offsetY = parseFloat($("#yOffset").val());
    drawFractal();
  });
