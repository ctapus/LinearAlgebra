...
$(document).ready(() => {
    ...
    $("#xOffset").change(() => {
        offsetX = parseInt($("#xOffset").val(), 10);
        offsetY = parseInt($("#yOffset").val(), 10);
        drawFractal();
    });
    $("#yOffset").change(() => {
        offsetX = parseInt($("#xOffset").val(), 10);
