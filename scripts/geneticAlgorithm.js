...
class Population {
    ...
    applySelection() {
        const individualsByFitness = this.individuals.sort((a, b) => a.fitness > b.fitness ? 1 : -1);
        const selectionPoint = Math.floor(Math.random() * this.individuals.length);
