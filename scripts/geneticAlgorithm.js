...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/exercises/geneticAlgorithm.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/*!*******************************************!*\
  !*** ./src/exercises/geneticAlgorithm.ts ***!
  \*******************************************/
/*! exports provided: Individual, Population */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Individual", function() { return Individual; });
...
class Individual {
    ...
    static randomGene() {
        let code = Math.floor(Math.random() * Individual.genesAlphabet.length);
...
Individual.genesAlphabet = " ABCDEFGHIJKLMNOPQRSTUVWXYZ";
class Population {
    ...
    applyCrossover(individual1, individual2) {
        let ret = [new Individual(), new Individual()];
    ...
    applyMutation(individual) {
        let ret = new Individual(individual);
    ...
    nextGeneration() {
        this.generations++;
        let selectionPoint = this.applySelection();
        let temp = new Array();
...
$(document).ready(() => {
    ...
    let tableResults = `<table id="tablResults" style="width: 100%">`;
